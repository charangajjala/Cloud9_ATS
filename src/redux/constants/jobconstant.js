...
export const JOB_TOP_APPLICANTS_REQUEST = "JOB_TOP_APPLICANTS_REQUEST";
export const JOB_TOP_APPLICANTS_SUCCESS = "JOB_TOP_APPLICANTS_SUCCESS";
export const JOB_TOP_APPLICANTS_FAIL = "JOB_TOP_APPLICANTS_FAIL";
